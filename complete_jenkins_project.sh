...
cd ~/ansible-projects/ansible-jenkins-cicd
...
echo "  cd ~/ansible-projects/ansible-jenkins-cicd"
echo "  git init"
echo "  git add ."
echo "  git commit -m 'Initial Jenkins CI/CD project'"
echo "  git remote add origin https://github.com/yourusername/ansible-jenkins-cicd.git"
